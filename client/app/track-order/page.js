    ...
    <div className="mx-auto max-w-2xl px-4 py-14 sm:px-6">
      ...
      <form onSubmit={lookup} className="mb-8 flex flex-col gap-3 sm:flex-row">
        <input
          ...
          className="flex-1 rounded-full border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/40 focus:border-cyan-400 focus:outline-none"
        />
        <input
          value={phone}
